        ...
        <div className="mt-4 mx-auto p-3 rounded" style={{width:'400px',background:'#cee'}}>
            <form>
                <div className="form-group mb-2">
                    ...
                    <input type="text" id="login" name="login" maxLength="20" className="form-control from-control-sm"/>
                </div>
                <div className="form-group mb-2">
                ...
                <div className="form-group mb-4">
                    ...
                    <textarea type="memo" name="memo" row="2" maxLength="200" className="form-control form-control-sm">
                    </textarea>
                </div>
